...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possível tentar excluir um usuário que não seja o seu"))
		return
	}
...
// SeguirUsuario permite um usuário seguir outro usuário.
...
// PararDeSeguirUsuario permite que um usuário pare de seguir outro usuário.
...
// Seguindo traz todos os usuários que um determinado usuário está seguindo.
