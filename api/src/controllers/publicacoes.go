...
// AtualizarPublicao altera os dados de uma publicação.
...
func DeletarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if erro = repositorio.Deletar(publicacaoID); erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, errors.New("não é possível atualizar uma publicação que não seja sua"))
		return
	}
...
// DescurtirPublicacao adiciona uma curtida na publicação.
